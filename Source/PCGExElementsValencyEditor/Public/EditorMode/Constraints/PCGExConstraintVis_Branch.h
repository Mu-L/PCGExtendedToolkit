...
/**
 * Visualizer for FPCGExConstraint_Branch.
 * Draws a Y-shaped fork to indicate conditional branching.
 */
class PCGEXELEMENTSVALENCYEDITOR_API FBranchVisualizer : public IConstraintVisualizer
{
public:
